...
def TabelaNaSlicniKorisnici(oceni):
    ...
    for person1 in oceni.keys():
        for person2 in oceni.keys():
            if person1 != person2:
                if person1 not in slicnosti.keys():
                    slicnosti[person1] = {}
                
                slicnosti[person1][person2] = (sim_distance(oceni,person1,person2), sim_pearson(oceni,person1,person2)[0], sim_pearson(oceni,person1,person2)[1])

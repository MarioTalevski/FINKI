...
if __name__ == "__main__":
    korisnik=input()
    print "user-based: {}".format(getUserBasedRecomendations(oceniPoKorisnici, korisnik)) 
    print "item-based: {}".format(getItemBasedRecomendations(oceniPoKorisnici, korisnik))
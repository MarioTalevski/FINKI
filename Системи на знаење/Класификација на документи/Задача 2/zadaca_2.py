...
class naivebayes(documentClassifier):
    ...
    def caclulateDocumentProbabilityInClass(self,item,currentCategory):
        ...
        p=1
        for currentFeature in features: p*=self.weightedprob(currentFeature,currentCategory,self.getFeaturePerCategoryProbability)
...
if __name__ == "__main__":
    ...
    # Експлицитно е напоменат типот на печатење во задачата:
    # "Печатењето не правете го со заокружување, 
    # туку со форматирано печатење.""
